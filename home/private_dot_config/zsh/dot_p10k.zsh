# Generated by Powerlevel10k configuration wizard on 2025-01-08 at 21:03 AEDT.
...
() {
  ...
  #################################[ os_icon: os identifier ]##################################
  # OS identifier color.
  typeset -g POWERLEVEL9K_OS_ICON_FOREGROUND=253 # light bg_0
  typeset -g POWERLEVEL9K_OS_ICON_BACKGROUND=235 # dark bg_1
  # Custom icon.
  ...
  typeset -g POWERLEVEL9K_DIR_FOREGROUND=255 # Light bg_00
  ...
  typeset -g POWERLEVEL9K_DIR_ANCHOR_FOREGROUND=254 # Light bg_00
  ...
  typeset -g POWERLEVEL9K_VCS_{CLEAN,MODIFIED,UNTRACKED}_FOREGROUND=234
  ...
  function my_git_formatter() {
    ...
    local       meta='%253F' # white foreground
    local      clean='%234F' # black foreground
    local   modified='%234F' # black foreground
    local  untracked='%234F' # black foreground
  ...
  ####################################[ hermit ]####################################
  typeset -g POWERLEVEL9K_HERMIT_FOREGROUND=6   # cyan
  typeset -g POWERLEVEL9K_HERMIT_BACKGROUND=235 # Dark bg_1

  function prompt_hermit() {
    if [[ -n $HERMIT_ENV ]]; then
      p10k segment -t "${${HERMIT_ENV:t}//\%/%%} 🐚"
    fi
  }
